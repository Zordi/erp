				...
				<div class="d-flex flex-column flex-lg-row-auto w-xl-600px positon-xl-relative" style="background-color: #F2C98A">
					...
					<div class="d-flex flex-column position-xl-fixed top-0 bottom-0 w-xl-600px scroll-y">
						...
						<div class="d-flex flex-row-fluid flex-column text-center p-10 pt-lg-20">
							...
							<!--end::Logo-->
							<!--begin::Title-->
							<h1 class="fw-bolder fs-2qx pb-5 pb-md-10" style="color: #986923;">Welcome to Kadasi</h1>
							<!--end::Title-->
							<!--begin::Description-->
							<p class="fw-bold fs-2" style="color: #986923;">Discover Amazing ERP
				...
				<div class="d-flex flex-column flex-lg-row-fluid py-10">
						...
						<div class="w-lg-500px p-10 p-lg-15 mx-auto">
							...
							<form class="form w-100" id="kt_sign_in_form" method="POST" action="{{ route('login') }}">
								...
								<div class="text-center mb-10">
									<!--begin::Title-->
									<h1 class="text-dark mb-3">Sign In to Kadasi</h1>
									<!--end::Title-->
									<!--begin::Link-->
								...
								<div class="fv-row mb-10">
									...
									<!--end::Label-->
									<!--begin::Input-->
									<input id="email" class="form-control form-control-lg form-control-solid" type="email" name="email" value="{{ old('email') }}" required autocomplete="email" autofocus />
									<!--end::Input-->
								</div>
								<!--end::Input group-->
								<!--begin::Input group-->
					...
					<div class="d-flex flex-center flex-wrap fs-6 p-5 pb-0">
						...
						<div class="d-flex flex-center fw-bold fs-6">
							<a href="https://teknodigital.id" class="text-muted text-hover-primary px-2" target="_blank">About</a>
							<a href="https://teknodigital.id" class="text-muted text-hover-primary px-2" target="_blank">Support</a>
						</div>
						<!--end::Links-->
					</div>
					<!--end::Footer-->
