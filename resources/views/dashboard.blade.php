    ...
    <div class="toolbar bg-transparent pt-6 mb-5" id="kt_toolbar">
        ...
        <div id="kt_toolbar_container" class="container-xxl d-flex flex-stack">
            ...
            <div data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', 'lg': '#kt_toolbar_container'}" class="page-title d-flex flex-column align-items-start me-3 mb-5 mb-lg-0">
                <!--begin::Title-->
                <h1 class="d-flex text-dark fw-bolder fs-3 flex-column mb-0">Finance Performance
                <!--begin::Description-->
                <span class="text-muted fs-7 fw-bold mt-2">Your balance is
                <span class="text-primary fw-bolder">24,567.76$</span></span>
                <!--end::Description--></h1>
                <!--end::Title-->
            </div>
            <!--end::Page title-->
                        ...
                        <div class="card-header pt-7">
                            ...
                            <div class="card-toolbar">
                                ...
                                <ul class="nav" id="kt_chart_widget_19_tabs">
                                    <li class="nav-item">
                                        <a class="nav-link btn btn-sm btn-color-muted btn-active btn-active-light active fw-bolder px-4 me-1" data-bs-toggle="tab" id="kt_chart_widget_19_tab_1" href="#kt_chart_widget_19_tab_content_1">2022</a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link btn btn-sm btn-color-muted btn-active btn-active-light fw-bolder px-4" data-bs-toggle="tab" id="kt_chart_widget_19_tab_2" href="#kt_chart_widget_19_tab_content_2">Month</a>
                                    </li>
                                </ul>
                            </div>
                            <!--end::Toolbar-->
