        ...
        <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
            ...
            <div class="d-flex align-items-center gap-2 gap-lg-3">
                ...
                <div class="m-0">
                    ...
                    <!--end::Menu toggle-->
                    <!--begin::Menu 1-->
                    <div class="menu menu-sub menu-sub-dropdown w-250px w-md-300px" data-kt-menu="true" id="kt_menu_624475fd04b8b">
                        <!--begin::Header-->
                        <div class="px-7 py-5">
                        ...
                        <div class="px-7 py-5">
                            ...
                            <div class="mb-10">
                                ...
                                <!--begin::Input-->
                                <div>
                                    <select class="form-select form-select-solid" data-kt-select2="true" data-placeholder="Select option" data-dropdown-parent="#kt_menu_624475fd04b8b" data-allow-clear="true">
                                        <option></option>
                    ...
                    <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_customers_table">
                        ...
                        <tbody class="fw-bold text-gray-600">
                            ...
                            <tr>
                                ...
                                <!--begin::Name=-->
                                <td>
                                    <a href="#" class="text-gray-800 text-hover-primary mb-1">{{ $cust->name }}</a>
                                </td>
                                <!--end::Name=-->
                                <!--begin::Email=-->
                                <td>
                                    <a href="#" class="text-gray-600 text-hover-primary mb-1">{{ $cust->email }}</a>
                                </td>
                                <!--end::Email=-->
                                <!--begin::Company=-->
                                <td><a href="#" class="text-gray-600 text-hover-primary mb-1">{{ $cust->phone }}</a></td>
                                <!--end::Company=-->
                                <!--begin::Payment method=-->
                                <td><a href="#" class="text-gray-600 text-hover-primary mb-1">{{ $cust->company }}</a></td>
                                <!--end::Payment method=-->
                                <!--begin::Date=-->
